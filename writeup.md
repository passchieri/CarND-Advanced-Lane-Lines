...
* **Code**: The code is stored in the jupyter notebook [CarND-Advanced-Lanes v2.ipynb](CarND-Advanced-Lanes v2.ipynb). The structure of the notebook is in line with the Rubric points, and this writeup. Code blocks will be referred based on sections in the notebook. A [pdf](CarND-advance-Lanes.pdf) of this notebook is also provided.
